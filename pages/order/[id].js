        ...
        <Layout>
            <div className={css.container}>
                ...
                <div className={css.details}>
                    ...
                    <div>
                        <span>Method</span>
                        <span>{order.method === 0 ? 'Cash on Deliver' : 'Online Payment(Paid)'}</span>
                    </div>
                    <div>
                        <span>Total</span>
                ...
                <div className={css.statusContainer}>
                    <div className={css.status}>
                        ...
                        <span>payment</span>
                        {
                            order.method === 0 ?
                                ...
                                :
                                <span className={css.completet}>Complete</span>
                        }
                    </div>
                    ...
                    <div className={css.status}>
                        <UilBox src={Onway} alt ="" width={50} height={50} />
                        <span>Delivered</span>
                        {
                            order.status === 3 && (
                                <div className={css.spinner}>
